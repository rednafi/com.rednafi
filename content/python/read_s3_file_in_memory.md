...
I frequently have to write ad-hoc scripts that download a CSV file from [S3], do some
...
Along with boto3, we can leverage Python's [tempfile.NamedTemporaryFile] to directly
