...
While working with GitHub webhooks, I discovered a [common pattern] a webhook receiver can
...
Also, check out how [Sentry implements this pattern].
...
[sentry implements this pattern]:
