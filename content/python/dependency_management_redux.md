...
In the simplest case, you can just run `pip install` to build the application. Check out [my
fastapi-nano project] that uses the workflow explained in this section.
...
> dependencies are defined with [PEP-508] strings, and environments use virtualenv._
...
> may be far off since [PEP-665] was rejected, resolving capabilities are coming to pip.
...
reference, check out [rubric], my linter CLI that follows this workflow.
