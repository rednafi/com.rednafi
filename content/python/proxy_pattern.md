...
`@abstractmethod` decorator. If your knowledge on decorator is fuzzy, then checkout my [post
on Python decorators]. The `@abstractmethod` decorator turns a normal method into an
