...
- Footnote style reference links
    ...
    refers to the backref at the bottom of the document. Like this: footnote style
...
the footnote numbers like [this][footnotes with extra texts]. Plus, you don't have to
manually create a separate reference section; it automatically gets created for you as you
start adding footnotes. See the reference section in this post and click on the backref
links to go back to the origin. Most parsers like [GitHub flavored Markdown] now support
footnotes out of the box.
